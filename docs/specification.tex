...
\begin{center}
    \begin{tabular}{ | m{3cm} | m{3cm}| m{2cm} |  m{5cm} |} 
      ...
      \hline
      ($<$n$>$,$<$n$>$) where n is an integer & Coordinate of {x: int; y: int} & n/a & x and y are integers. A coordinate is a primitive that represents where on the field a player is. \\ 
      \hline
      $<$coordinate$>$ , bool & Offense of Coordinate * HasDisc & n/a & An offensive player is made up of a coordinate and a boolean value of whether or not they have the disc. The player is drawn on the field in the appropriate location with/without the disc based on this information. \\ 
      \hline
      ($<$offense$>$, $<$offensive$>$) $|$ $<$offense$>$ & Offensive of Offense list & n/a & Offensive (which symbolizes an offensive team) is a list of offensive players. This is a combining form of offensive players. \\
      \hline
    \end{tabular}
\end{center}
